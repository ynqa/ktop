...
require (
	...
	k8s.io/metrics v0.0.0-20190228180609-34472d076c30
)
...
require (
	...
	github.com/gophercloud/gophercloud v0.0.0-20190315020455-954aa14363ce // indirect
